...
export const configureSuccessfulPairing = (
	...
	// lid from WA server — stored in creds for backwards compat; addressing uses jid (phone JID)
	...
	// Signal identity uses lid from server pairing — this is required for E2E crypto
	...
	const authUpdate: Partial<AuthenticationCreds> = {
		account,
		me: { id: jid!, name: bizName, lid }, // lid stored for server compat (JID-first: use id for addressing)

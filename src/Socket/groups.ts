...
export const extractGroupMetadata = (result: BinaryNode) => {
	...
	const metadata: GroupMetadata = {
		...
		addressingMode: WAMessageAddressingMode.PN, // JID-first: always PN, ignore server LID mode
		...
		participants: getBinaryNodeChildren(group, 'participant').map(({ attrs }) => {
			// JID-first: if server gives LID jid, prefer phone_number as canonical id
			...
			return {
				...
				lid: undefined, // JID-first: deprecated

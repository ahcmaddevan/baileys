...
import type { AuthenticationCreds, JIDMapping, LIDMapping } from './Auth'
...
export type BaileysEventMap = {
	...
	'messaging-history.set': {
		...
		contacts: Contact[]
		messages: WAMessage[]
		/** @deprecated use jidPnMappings */
		lidPnMappings?: LIDMapping[]
		jidPnMappings?: JIDMapping[]
		isLatest?: boolean
	...
	/** @deprecated use jid-mapping.update */
	'lid-mapping.update': LIDMapping
	'jid-mapping.update': JIDMapping

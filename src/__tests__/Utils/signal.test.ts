...
import type { SignalRepositoryWithJIDStore } from '../../Types'
...
describe('parseAndInjectE2ESessions', () => {
	it('should process all user node', async () => {
		const mockRepository = {
			injectE2ESession: jest.fn<SignalRepositoryWithJIDStore['injectE2ESession']>()
		} as jest.Mocked<Pick<SignalRepositoryWithJIDStore, 'injectE2ESession'>>

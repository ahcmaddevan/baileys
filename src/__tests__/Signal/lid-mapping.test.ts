...
import P from 'pino'
import { JIDMappingStore } from '../../Signal/jid-mapping'
import type { JIDMapping, SignalDataTypeMap, SignalKeyStoreWithTransaction } from '../../Types'
...
describe('JIDMappingStore', () => {
	const mockPnToJIDFunc = jest.fn<(jids: string[]) => Promise<JIDMapping[] | undefined>>()
	let lidMappingStore: JIDMappingStore

	beforeEach(() => {
		jest.clearAllMocks()
		lidMappingStore = new JIDMappingStore(mockKeys, logger, mockPnToJIDFunc)
	})
